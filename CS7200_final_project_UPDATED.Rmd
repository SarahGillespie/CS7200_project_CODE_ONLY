...
summary(fit2) 
# trt group is significant compared to ctrl but less upright
# second half not significant compared to first half but small increase in upright

fit3 <- lmer(ambulation_prop ~ half + (1|PARTICIPANT), part_3, REML=F)
summary(fit3)
# second half is not significant compared to first half but small increase in ambulation
...
# second half is significant compared to first half and small increase in ambulation
